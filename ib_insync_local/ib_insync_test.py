...
def run_ib_test(stock_settings, csv_file):
    ...
    # stock_name, bar_size, end_data_time, duration_time = collect_stock_settings()
    ...
    # csv_file = f"C:/Users/Israel/PycharmProjects/market ib api/reports/{stock_settings.stock_name}_bars_{stock_settings.bar_size}.csv"
    ...
    with open(csv_file, mode="w", newline='', encoding='utf-8') as file:
        ...
        bars = ib.reqHistoricalData(
                stock,
                endDateTime=stock_settings["end_data_time"],
                durationStr= stock_settings["duration_time"],
                barSizeSetting= stock_settings["bar_size"],
                whatToShow='MIDPOINT',
                useRTH=True,
            )
        if not bars:
