...
def bollinger_bands():
    ...
    stock_name = stock_settings["stock_name"]
    csv_name = f"period-{stock_settings["duration_time"]}_bars-{stock_settings["bar_size"]}"
    csv_file = f"{root_path}/reports/bars/{stock_name}/{csv_name}.csv"
    ...
    try:
        analyze_path = run_backtest(bb_settings, csv_name, {stock_name}, root_path,
